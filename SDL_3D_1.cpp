...
int main(int argc, char* argv[])
{
    ...
    std::vector<Object3D> allObjects;
     ...
     allObjects[0].rotationY = 0.004;
  // allObjects[0].rotationZ = -0.0022;

     allObjects[0].speedX = 0.25;
     allObjects[0].speedY = -0.25;
     allObjects[0].speedZ = 0;
    

     allObjects.emplace_back(Object3D({-300,-300,1500},70));
   
     allObjects[1].speedX = -0.25;
     allObjects[1].speedY = 0.25;
     allObjects[1].speedZ = 0.0;
   
     allObjects[1].rotationX = 0.001;
     allObjects[1].rotationY = 0.002;
